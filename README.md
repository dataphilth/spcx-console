...
config/tape.yaml       share structure, catalysts, signal thresholds (context, never criteria)
spcx/tape/             prices · options · technical · setups · catalysts · run · dashboard
...
python -m spcx.cli tape          # price / vol / setups → data/tape.json (context only)
