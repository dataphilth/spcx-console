...
range and compression, volume z-score, distance from ATH/ATL/IPO/cost basis; IV30
and IV90 from the listed chain, front-expiry expected move, put/call OI, IV−HV
spread, IV rank over stored history (labelled "thin" under 60 sessions).

What it surfaces: setups — stretch, RSI extremes, 20-day breakout/breakdown,
volume climax, compression, premium rich/cheap, catalyst window. **Every setup
...
tests/                 41 tests, run before every collection
```
